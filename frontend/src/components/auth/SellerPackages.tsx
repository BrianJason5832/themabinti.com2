...
const SellerPackages = () => {
  ...
  const handleMpesaPay = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://themabinti-com2-7ci5.vercel.app/api/mpesa/stkpush', {
    ...
    if (paymentStatusDialogOpen && mpesaNumber) {
      ...
      pollingRef.current = setInterval(async () => {
        try {
          ...
          const res = await axios.get('https://themabinti-com2-7ci5.vercel.app/api/mpesa/payment-status', {
